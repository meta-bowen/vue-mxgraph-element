...
export class Graph extends mxGraph {
  ...
  _putVertexStyle() {
    ...
    const nodeStyle = {
      ...
      [mxConstants.STYLE_ARCSIZE]: 12, // 设置圆角程度
  
      [mxConstants.STYLE_STROKECOLOR]: 'rgba(255, 255, 255, 0)',
      [mxConstants.STYLE_FONTCOLOR]: 'rgba(0, 0, 0, 0.65)',
      [mxConstants.STYLE_FILLCOLOR]: 'rgba(255, 255, 255, 0)',
      //
      ...
      [mxConstants.STYLE_IMAGE_WIDTH]: '96',
      [mxConstants.STYLE_IMAGE_HEIGHT]: '84',
      [mxConstants.STYLE_SPACING_TOP]: '76',
  ...
  _setDefaultEdgeStyle() {
    ...
    Object.assign(style, {
      ...
      [mxConstants.STYLE_STROKECOLOR]: 'rgba(96, 183, 255, 1)',
